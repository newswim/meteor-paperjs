 ...
 var paper = new function(t) {
        ...
        statics: {
            ...
            deserialize: function(t, n, i) {
                ...
                if (i = i || {}, Array.isArray(t)) {
                    ...
                    r = [];
                    for (var o = s ? 1 : 0, h = t.length; h > o; o++) r.push(e.deserialize(t[o], n, i));
                    if (a) i.dictionary = r[0];
                    else if (s) {
                        var u = r;
                        n ? r = n(s, u) : (r = e.create(s.prototype), s.apply(r, u))
                    }
                } else if (e.isPlainObject(t)) {
                    r = {};
    ...
    var n = {
        ...
        r = e.extend({
            ...
            initialize: function re() {
                ...
                var t = re.prototype;
                if (!this.support) {
                    var n = K.getContext(1, 1);
                    t.support = {
                        nativeDash: "setLineDash" in n || "mozDash" in n,
                        nativeBlendModes: Q.nativeModes
                    }, K.release(n)
                }
                if (!this.browser) {
                    var i = t.browser = {};
    ...
    var o = new function() {
            function e(e, n, i) {
                var r = n === t,
                    ...
                    o = 0;
                return function(t) {
                    return (r || t > s && a > t) && (e[o++] = n > t ? n : t > i ? i : t), o
                }
            }
            var n = [
                    [.5773502691896257],
                ...
                solveCubic: function(t, n, i, l, d, f, _) {
                    ...
                    if (0 > w) {
                        var x = s(v),
                            ...
                            S = -2 * x,
                            P = 2 * u / 3;
                        return g(S * h(C) - n), g(S * h(C + P) - n), g(S * h(C - P) - n)
                    }
        ...
        p = e.extend({
            ...
            statics: {
                ...
                getSignedDistance: function(t, e, n, i, r, s, a) {
                    if (a || (n -= t, i -= e), o.isZero(n)) return r - t;
                    var h = i / n,
                        u = e - h * t;
                    return (s - h * r - u) / Math.sqrt(h * h + 1)
                }
            }
        }),
        v = s.extend({
            ...
            _reference: "project",
            initialize: function(t) {
                s.call(this, !0), this.layers = [], this._activeLayer = null, this.symbols = [], this._currentStyle = new F(null, null, this), this._view = Z.create(this, t || K.getCanvas(1, 1)), this._selectedItems = {}, this._selectedItemCount = 0, this._updateVersion = 0
            },
            ...
            remove: function ae() {
                return ae.base.call(this) ? (this._view && this._view.remove(), !0) : !1
            },
            getView: function() {
                return this._view
            },
        ...
        m = e.extend({
            _class: "Symbol",
            initialize: function oe(t, e) {
                this._id = oe._id = (oe._id || 0) + 1, this.project = paper.project, this.project.symbols.push(this), t && this.setDefinition(t, e)
            },
            _serialize: function(t, n) {
        ...
        y = e.extend(n, {
            statics: {
                extend: function he(t) {
                    return t._serializeFields && (t._serializeFields = new e(this.prototype._serializeFields, t._serializeFields)), he.base.apply(this, arguments)
                },
                NO_INSERT: {
                    insert: !1
                }
            ...
            _hitTest: function(n, i) {
                function r(i, r) {
                    var s = _["get" + r]();
                    return n.subtract(s).divide(u).length <= 1 ? new P(i, f, {
                        name: e.hyphenate(r),
                        point: s
                    }) : t
                }
                ...
                var s = this._matrix,
                    ...
                    u = i._tolerancePadding = new c(O._getPenPadding(1, h.inverted())).multiply(Math.max(i.tolerance, 1e-5));
            ...
            statics: {
                _getItems: function le(t, n, i, r, s) {
                    if (!r) {
                        var a = n.overlapping,
                            o = n.inside,
                            h = a || o,
                    ...
                    for (var c = 0, d = t && t.length; d > c; c++) {
                        ...
                        if (le(_._children, n, p, r, s), s && l.length > 0) break
                    }
                    return l
                }
            }
            ...
            insertChildren: function(t, n, i, r) {
                ...
                if (s && n && n.length > 0) {
                    ...
                    for (var a = n.length - 1; a >= 0; a--) {
                        var o = n[a];
                        !r || o instanceof r ? o._remove(!1, !0) : n.splice(a, 1)
                    }
                    e.splice(s, n, t, 0);
            ...
            transform: function(t, e) {
                ...
                if (t && n.preConcatenate(t), i = i && this._transformContent(n)) {
                    ...
                    r && n._transformPoint(r, r, !0), a && a.transform(n), o && o.transform(n), n.reset(!0)
                }
                var h = this._bounds,
                    u = this._position;
                this._changed(9);
                ...
                if (this._visible && 0 !== this._opacity) {
                    ...
                    if (h.isInvertible()) {
                        ...
                        if (!p) {
                            ...
                            c = e.offset, l = e.offset = m.getTopLeft().floor(), u = t, t = K.getContext(m.getSize().ceil().add(1).multiply(v)), 1 !== v && t.scale(v, v)
                        }
                        t.save();
                        ...
                        this._draw(t, e, y), t.restore(), s.pop(), e.clip && !e.dontFinish && t.clip(), p || (Q.process(d, t, u, f, l.subtract(c).multiply(v)), K.release(t), e.offset = c)
                    }
                }
            },
        ...
        w = y.extend({
            ...
            _changed: function ce(e) {
                ce.base.call(this, e), 1026 & e && (this._clipItem = t)
            },
        ...
        x = w.extend({
            ...
            _insert: function pe(t, n, i) {
                return n instanceof x && !n._parent ? (this._remove(!0, !0), e.splice(n._project.layers, [this], n._index + (t ? 1 : 0), 0), this._setProject(n._project, !0), this) : pe.base.call(this, t, n, i)
            }
        }),
        b = y.extend({
            _class: "Shape",
        ...
        C = y.extend({
            ...
            initialize: function(e, n) {
                this._initialize(e, n !== t && h.read(arguments, 1)) || ("string" == typeof e ? this.setSource(e) : this.setImage(e)), this._size || (this._size = new c)
            },
            _equals: function(t) {
            ...
            setSize: function() {
                ...
                if (!this._size.equals(t)) {
                    ...
                    this.setCanvas(K.getCanvas(t)), e && this.getContext(!0).drawImage(e, 0, 0, t.width, t.height)
                }
            },
            getWidth: function() {
            ...
            setImage: function(t) {
                this._canvas && K.release(this._canvas), t && t.getContext ? (this._image = null, this._canvas = t) : (this._image = t, this._canvas = null), this._size = new c(t ? t.naturalWidth || t.width : 0, t ? t.naturalHeight || t.height : 0), this._context = null, this._changed(521)
            },
            getCanvas: function() {
                if (!this._canvas) {
                    var t = K.getContext(this._size);
                    try {
            ...
            setSource: function(t) {
                ...
                var n, i = this;
                n = document.getElementById(t) || new Image, n.naturalWidth && n.naturalHeight ? setTimeout(e, 0) : (V.add(n, {
                    load: e
            ...
            getAverageColor: function(t) {
                ...
                var r = 32,
                    ...
                    o = C._sampleContext;
                o ? o.clearRect(0, 0, r + 1, r + 1) : o = C._sampleContext = K.getContext(new c(r)), o.save();
                ...
                for (var u = o.getImageData(.5, .5, Math.ceil(s), Math.ceil(a)).data, l = [0, 0, 0], d = 0, _ = 0, p = u.length; p > _; _ += 4) {
                    var v = u[_ + 3];
                    d += v, v /= 255, l[0] += u[_] * v, l[1] += u[_ + 1] * v, l[2] += u[_ + 2] * v
                }
        ...
        k = e.extend({
            ...
            initialize: function(e, n, i, r, s, a) {
                ...
                0 === l || (1 === l ? e.point ? (o = e.point, h = e.handleIn, u = e.handleOut) : o = e : 2 === l && "number" == typeof e ? o = arguments : 3 >= l ? (o = e, h = n, u = i) : (o = e !== t ? [e, n] : null, h = i !== t ? [i, r] : null, u = s !== t ? [s, a] : null)), new M(o, this, "_point"), new M(h, this, "_handleIn"), new M(u, this, "_handleOut")
            },
            _serialize: function(t) {
        ...
        I = e.extend({
            ...
            initialize: function(t, e, n, i, r, s, a, o) {
                ...
                else if (0 === h) this._segment1 = new k, this._segment2 = new k;
                else if (1 === h) this._segment1 = new k(t.segment1), this._segment2 = new k(t.segment2);
                else if (2 === h) this._segment1 = new k(t), this._segment2 = new k(e);
                else {
                    var u, l, c, d;
                    4 === h ? (u = t, l = e, c = n, d = i) : 8 === h && (u = [t, e], d = [a, o], l = [n - t, i - e], c = [r - a, s - o]), this._segment1 = new k(u, null, l), this._segment2 = new k(d, c, null)
                }
            },
            _changed: function() {
            ...
            divide: function(t, e, n) {
                var i = this._getParameter(t, e),
                    ...
                    s = null;
                if (i > r && 1 - r > i) {
                    var a = I.subdivide(this.getValues(), i),
                        o = n ? !1 : this.isLinear(),
                        u = a[0],
                        l = a[1];
            ...
            statics: {
                ...
                getParameterOf: function(t, e, n) {
                    ...
                    for (var r, s, a = [], o = [], h = I.solveCubic(t, 0, e, a, 0, 1), u = I.solveCubic(t, 1, n, o, 0, 1), l = 0; - 1 == h || h > l;)
                        if (-1 == h || (r = a[l++]) >= 0 && 1 >= r) {
                            for (var c = 0; - 1 == u || u > c;)
                ...
                getPart: function(t, e, n) {
                    return e > 0 && (t = I.subdivide(t, e)[1]), 1 > n && (t = I.subdivide(t, (n - e) / (1 - e))[0]), t
                },
                isLinear: function(t) {
                    var e = o.isZero;
            ...
            this[t + "At"] = function(t, n) {
                ...
                return I.evaluate(i, n ? t : I.getParameterAt(i, t, 0), e)
            }, this[t] = function(t) {
            ...
            getLocationAt: function(t, e) {
                return e || (t = this.getParameterAt(t)), t >= 0 && 1 >= t && new z(this, t)
            },
            ...
            getNearestLocation: function() {
                function t(t) {
                    if (t >= 0 && 1 >= t) {
                        var i = e.getDistance(I.evaluate(n, t, 0), !0);
                        if (r > i) return r = i, s = t, !0
                    }
                }
                for (var e = h.read(arguments), n = this.getValues(), i = 100, r = 1 / 0, s = 0, a = 0; i >= a; a++) t(a / i);
                for (var o = 1 / (2 * i); o > 1e-5;) t(s - o) || t(s + o) || (o /= 2);
                var u = I.evaluate(n, s, 0);
                return new z(this, s, u, null, null, null, e.getDistance(u))
            },
            ...
            return {
                ...
                getParameterAt: function(i, r, s) {
                    ...
                    var f = r / d,
                        _ = 0;
                    return o.findRoot(a, c, s + f, u, l, 16, 1e-5)
                }
            }
        }, new function() {
            function t(t, e, n, i, r, s, a, o) {
                var h = new z(n, i, r, s, a, o);
                (!e || e(h)) && t.push(h)
            }
            ...
            function e(r, s, a, o, h, u, l, c, d, f, _, g, v) {
                if (!(v > 20)) {
                    var m, y, w, x = s[0],
                        ...
                        j = M(x, b, C, S, r[4], r[5]),
                        B = M(x, b, C, S, r[6], r[7]);
                    if (x === C && k >= f - d && v > 3) m = (c + l) / 2, y = m, w = 0;
                    else {
                        var D, R, F = n(E, N, j, B),
                            q = F[0],
                            V = F[1];
                        if (D = i(q, V, T, L), q.reverse(), V.reverse(), R = i(q, V, T, L), null == D || null == R) return !1;
                        r = I.getPart(r, D, R), w = R - D, m = c * D + l * (1 - D), y = c * R + l * (1 - R)
                    }
                    if (_ > .8 && w > .8)
                        if (y - m > f - d) {
                            var Z = I.subdivide(r, .5),
                                U = m + (y - m) / 2;
                            e(s, Z[0], o, a, h, u, d, f, m, U, w, !g, ++v), e(s, Z[1], o, a, h, u, d, f, U, y, w, !g, v)
                        } else {
                            var Z = I.subdivide(s, .5),
                                U = d + (f - d) / 2;
                            e(Z[0], r, o, a, h, u, d, U, m, y, w, !g, ++v), e(Z[1], r, o, a, h, u, U, f, m, y, w, !g, v)
                        } else if (Math.max(f - d, y - m) < P) {
                        var H = m + (y - m) / 2,
                            W = d + (f - d) / 2;
                        g ? t(h, u, o, W, I.evaluate(s, W, 0), a, H, I.evaluate(r, H, 0)) : t(h, u, a, H, I.evaluate(r, H, 0), o, W, I.evaluate(s, W, 0))
            ...
            function i(t, e, n, i) {
                for (var r, s, a, o, h, u = null, l = 0, c = e.length - 1; c > l; l++) {
                    if (a = e[l][1], h = e[l + 1][1], h > a) r = null;
                        ...
                        if (!(i >= h)) continue;
                        s = e[l][0], o = e[l + 1][0], r = s + (i - a) * (o - s) / (h - a)
                    }
                    break
                }
                t[0][1] <= i && (r = t[0][0]);
                for (var l = 0, c = t.length - 1; c > l; l++) {
                    if (a = t[l][1], h = t[l + 1][1], a >= n) u = r;
                        ...
                        if (!(h >= n)) continue;
                        s = t[l][0], o = t[l + 1][0], u = s + (n - a) * (o - s) / (h - a)
                    }
                    break
                }
                return u
            ...
            function r(e, n, i, r, s, a) {
                for (var o = I.isLinear(e), h = o ? n : e, u = o ? e : n, l = u[0], c = u[1], d = u[6], f = u[7], _ = d - l, g = f - c, p = Math.atan2(-g, _), v = Math.sin(p), m = Math.cos(p), y = _ * m - g * v, w = [0, 0, 0, 0, y, 0, y, 0], x = [], b = 0; 8 > b; b += 2) {
                    var C = h[b] - l,
                        S = h[b + 1] - c;
                    x.push(C * m - S * v, S * m + C * v)
                }
                for (var P = [], k = I.solveCubic(x, 1, 0, P, 0, 1), b = 0; k > b; b++) {
                    var M = P[b],
                        C = I.evaluate(x, M, 0).x;
                    if (C >= 0 && y >= C) {
                        var z = I.getParameterOf(w, C, 0),
                            A = o ? z : M,
                            O = o ? M : z;
                        t(s, a, i, A, I.evaluate(e, A, 0), r, O, I.evaluate(n, O, 0))
                    }
                }
            }
            ...
            function s(e, n, i, r, s, a) {
                ...
                if (o) {
                    var h = o.x,
                        u = o.y;
                    t(s, a, i, I.getParameterOf(e, h, u), o, r, I.getParameterOf(n, h, u), o)
                }
            }
            return {
                statics: {
                    getIntersections: function(t, n, i, a, o, h) {
                        var u = I.isLinear(t),
                            l = I.isLinear(n);
                        return (u && l ? s : u || l ? r : e)(t, n, i, a, o, h, 0, 1, 0, 1, 0, !1, 0), o
                    }
                }
            }
        }),
        z = e.extend({
            ...
            beans: !0,
            initialize: function ve(t, e, n, i, r, s, a) {
                this._id = ve._id = (ve._id || 0) + 1, this._curve = t, this._segment1 = t._segment1, this._segment2 = t._segment2, this._parameter = e, this._point = n, this._curve2 = i, this._parameter2 = r, this._point2 = s, this._distance = a
            },
            ...
            getIntersection: function() {
                ...
                if (!t && this._curve2) {
                    ...
                    this._intersection = t = new z(this._curve2, e, this._point2 || this._point, this), t._intersection = this
                }
                return t
            },
            getPath: function() {
        ...
        A = y.extend({
            ...
            getIntersections: function(e, n, i) {
                ...
                var s = [],
                    a = this.getCurves(),
                    o = e ? e.getCurves() : a,
                    h = this._matrix.orNullIfIdentity(),
                    u = e ? (n || e._matrix).orNullIfIdentity() : h,
                    l = a.length,
                    c = e ? o.length : l,
                    d = [],
                    f = 1e-11,
                    _ = 1 - 1e-11;
                if (e && !this.getBounds(h).touches(e.getBounds(u))) return [];
                for (var g = 0; c > g; g++) d[g] = o[g].getValues(u);
                for (var g = 0; l > g; g++) {
                    var v = a[g],
                        m = e ? v.getValues(h) : d[g];
                    if (!e) {
                        var y = v.getSegment1(),
                            w = v.getSegment2(),
                            x = y._handleOut,
                            b = w._handleIn;
                        if (new p(y._point.subtract(x), x.multiply(2), !0).intersect(new p(w._point.subtract(b), b.multiply(2), !0), !1)) {
                            var C = I.subdivide(m);
                            I.getIntersections(C[0], C[1], v, v, s, function(e) {
                                return e._parameter <= _ ? (e._parameter /= 2, e._parameter2 = .5 + e._parameter2 / 2, !0) : t
                            })
                        }
                    }
                    for (var S = e ? 0 : g + 1; c > S; S++) I.getIntersections(m, d[S], v, o[S], s, !e && (S === g + 1 || S === c - 1 && 0 === g) && function(t) {
                        var e = t._parameter;
                        return e >= f && _ >= e
                    })
                }
                for (var P = s.length - 1, g = P; g >= 0; g--) {
                    var k = s[g],
                        M = k._curve.getNext(),
                        z = k._curve2.getNext();
                    M && k._parameter >= _ && (k._parameter = 0, k._curve = M), z && k._parameter2 >= _ && (k._parameter2 = 0, k._curve2 = z)
                }
                if (P > 0) {
                    s.sort(r);
                    for (var g = P; g >= 1; g--) s[g].equals(s[0 === g ? P : g - 1]) && (s.splice(g, 1), P--)
                }
                if (i) {
                    for (var g = P; g >= 0; g--) s.push(s[g].getIntersection());
                    s.sort(r)
                }
                return s
            },
        ...
        O = A.extend({
            ...
            _changed: function me(e) {
                if (me.base.call(this, e), 8 & e) {
                    var n = this._parent;
            ...
            _add: function(t, e) {
                ...
                if (i || t._curves) {
                    ...
                    for (var a = l; c > a; a++) i.splice(a, 0, new I(this, null, null));
            ...
            flatten: function(t) {
                for (var e = new L(this, 64, .1), n = 0, i = e.length / Math.ceil(e.length / t), r = e.length + (this._closed ? -i : i) / 2, s = []; r >= n;) s.push(new k(e.evaluate(n, 0))), n += i;
                this.setSegments(s)
            },
            reduce: function() {
            ...
            split: function(t, e) {
                if (null !== e) {
                    ...
                    if (t >= 0 && t < r.length) {
                        ...
                        return this._closed ? (this.setClosed(!1), s = this) : t > 0 && (s = this._clone((new O).insertAbove(this, !0))), s._add(a, 0), this.addSegment(a[0]), s
                    }
                    return null
                }
            },
            ...
            _hitTestSelf: function(t, e) {
                ...
                function a(e) {
                    if (("round" !== o || "round" !== u) && (c = new O({
                            internal: !0,
                            closed: !0
                        }), m || e._index > 0 && e._index < v - 1 ? "round" !== o && (e._handleIn.isZero() || e._handleOut.isZero()) && O._addBevelJoin(e, o, S, l, s, !0) : "round" !== u && O._addSquareCap(e, u, S, s, !0), !c.isEmpty())) {
                        var i;
                ...
                if (null !== S) {
                    if (d = this.getNearestLocation(t)) {
                        ...
                        0 === M || 1 === M && v > 1 ? a(d.getSegment()) || (d = null) : n(d.getPoint(), w) || (d = null)
                    }
                    if (!d && "miter" === o && v > 1)
                        for (var k = 0; v > k; k++) {
                            var I = p[k];
            ...
            getLocationAt: function(t, e) {
                ...
                return t <= this.getLength() ? new z(n[n.length - 1], 1) : null
            },
            getNearestLocation: function() {
            ...
            return {
                moveTo: function() {
                    ...
                    1 === t.length && this.removeSegment(0), t.length || this._add([new k(h.read(arguments))])
                },
                moveBy: function() {
                ...
                arcTo: function() {
                    ...
                    if ("boolean" == typeof f) var _ = u.add(l).divide(2),
                        ...
                        var m = e.read(arguments),
                            ...
                            O = b * b,
                            T = Math.sqrt(A / I + O / z);
                        if (T > 1 && (P *= T, M *= T, I = P * P, z = M * M), T = (I * z - I * O - z * A) / (I * O + z * A), C(T) < S && (T = 0), 0 > T) throw Error("Cannot create an arc with the given arguments");
                        i = new h(P * b / M, -M * x / P).multiply((y === f ? -1 : 1) * Math.sqrt(T)).rotate(m).add(_), a = (new g).translate(i).rotate(m).scale(P, M), s = a._inverseTransform(u), r = s.getDirectedAngle(a._inverseTransform(l)), !f && r > 0 ? r -= 360 : f && 0 > r && (r += 360)
                    }
                    if (n) {
                    ...
                    for (var D = Math.abs(r), R = D >= 360 ? 4 : Math.ceil(D / 90), F = r / R, q = F * Math.PI / 360, V = 4 / 3 * Math.sin(q) / (1 + Math.cos(q)), Z = [], U = 0; R >= U; U++) {
                        ...
                        if (R > U && (H = s.rotate(90).multiply(V), a ? (w = a._transformPoint(s), H = a._transformPoint(s.add(H)).subtract(w)) : w = i.add(s)), 0 === U) o.setHandleOut(H);
                            ...
                            a && (W = a._transformPoint(s.add(W)).subtract(w)), Z.push(new k(w, W, H))
                        }
                        s = s.rotate(F)
                    }
                    this._add(Z)
            ...
            statics: {
                isClockwise: function(t) {
                    for (var e = 0, n = 0, i = t.length; i > n; n++)
                        for (var r = I.getValues(t[n], t[i > n + 1 ? n + 1 : 0]), s = 2; 8 > s; s += 2) e += (r[s - 2] - r[s]) * (r[s + 1] + r[s - 1]);
                    return e > 0
                },
                ...
                getStrokeBounds: function(t, e, n, i) {
                    ...
                    function a(t, e) {
                        var n = t._handleIn,
                            i = t._handleOut;
                        "round" === e || !n.isZero() && !i.isZero() && n.isColinear(i) ? s(t) : O._addBevelJoin(t, e, u, p, r)
                    }
                    ...
                    for (var h = t.length - (e ? 0 : 1), u = n.getStrokeWidth() / 2, l = O._getPenPadding(u, i), d = O.getBounds(t, e, n, i, l), _ = n.getStrokeJoin(), g = n.getStrokeCap(), p = u * n.getMiterLimit(), v = new f(new c(l).multiply(2)), m = 1; h > m; m++) a(t[m], _);
    ...
    A.inject(new function() {
        function t(t, r, s, a) {
            ...
            function h(t) {
                for (var e = 0, n = t.length; n > e; e++) {
                    var i = t[e];
                    _.push.apply(_, i._segments), g.push.apply(g, i._getMonoCurves())
                }
            }
            var u = o(t),
                l = r && t !== r && o(r);
            u.isClockwise() || u.reverse(), !l || a ^ l.isClockwise() || l.reverse(), e(u.getIntersections(l, null, !0));
            var c = [],
                d = [],
                f = [],
                _ = [],
                g = [];
            h(u._children || [u]), l && h(l._children || [l]), _.sort(function(t, e) {
            ...
            for (var p = 0, v = _.length; v > p; p++) {
                ...
                if (null == m._winding) {
                    ...
                    var y = 0,
                        w = m;
                    do c.push(m), f.push(y += m.getCurve().getLength()), m = m.getNext(); while (m && !m._intersection && m !== w);
                    for (var x = 0; 3 > x; x++) {
                        var b = y * Math.random(),
                            C = f.length,
                            S = 0;
                        ...
                        var P = c[S].getCurve(),
                            ...
                            M = P.isHorizontal(),
                            I = P._path;
                        I._parent instanceof T && (I = I._parent), d[x] = a && l && (I === u && l._getWinding(k, M) || I === l && !u._getWinding(k, M)) ? 0 : n(k, g, M)
                    }
                    d.sort();
                    for (var z = d[1], x = c.length - 1; x >= 0; x--) c[x]._winding = z
                }
            }
            var A = new T;
            return A.addChildren(i(_, s), !0), u.remove(), l && l.remove(), A = A.reduce(), A.setStyle(t._style), A
        }
        ...
        function e(t) {
            ...
            for (var n, i, r, s = 1e-5, a = t.length - 1; a >= 0; a--) {
                ...
                var u, l;
                (u = i.divide(h, !0, !0)) ? (l = u._segment1, i = u.getPrevious()) : l = s > h ? i._segment1 : h > 1 - s ? i._segment2 : i.getPartLength(0, h) < i.getPartLength(h, 1) ? i._segment1 : i._segment2, l._intersection = o.getIntersection(), o._segment = l, n && n.push(l), r = o
            }
            n && e()
        }
            ...
            if (i) {
                for (var _ = -1 / 0, g = 1 / 0, p = o - s, v = o + s, m = 0, y = e.length; y > m; m++) {
                    ...
                    if (I.solveCubic(w, 0, a, c, 0, 1) > 0)
                        for (var x = c.length - 1; x >= 0; x--) {
                            var b = I.evaluate(w, c[x], 0).y;
                            p > b && b > _ ? _ = b : b > v && g > b && (g = b)
                        }
                }
                _ = (_ + o) / 2, g = (g + o) / 2, _ > -1 / 0 && (u = n(new h(a, _), e)), 1 / 0 > g && (l = n(new h(a, g), e))
            } else
                for (var C = a - s, S = a + s, m = 0, y = e.length; y > m; m++) {
                    var P = e[m],
                        ...
                        k = P.winding,
                        M = P.next;
                    if (k && (1 === k && o >= w[1] && o <= w[7] || o >= w[7] && o <= w[1]) && 1 === I.solveCubic(w, 1, o, c, 0, M.winding || M.values[1] !== o ? f : 1)) {
                        var z = c[0],
                            A = I.evaluate(w, z, 0).x,
                            O = I.evaluate(w, z, 1).y;
                        d(O) < s && !I.isLinear(w) || s > z && O * I.evaluate(P.previous.values, z, 1).y < 0 ? r && A >= C && S >= A && (++u, ++l) : C >= A ? u += k : A >= S && (l += k)
                    }
                }
        ...
        function i(t, e, n) {
            ...
            for (var i, r, s = [], a = .001, o = .999, h = 0, u = t.length; u > h; h++)
                    ...
                    do {
                        ...
                        if (f && (!e(i._winding) || n) && (c = i._intersection) && (g = c._segment) && g !== r) {
                            if (n) i._visited = g._visited, i = g, _ = 1;
                                ...
                                if (0 !== P * M) {
                                    var I = M > P ? b : x,
                                        z = e(I._segment1._winding) ? I : M > P ? x : b,
                                        A = z._segment1;
                        ...
                        l.add(new k(i._point, f && p, v)), f = !0, i._visited = !0, i = _ > 0 ? i.getNext() : i.getPrevious()
                ...
                if (0 !== I.getLength(e)) {
                    ...
                    if (I.isLinear(e)) t(e);
                        ...
                        if (0 === d) t(e);
                            ...
                            var f = c[0],
                                _ = I.subdivide(e, f);
                            t(_[0]), d > 1 && (f = (c[1] - f) / (1 - f), _ = I.subdivide(_[1], f), t(_[0])), t(_[1])
                        }
                    }
                }
            }
            ...
            if (!this.contains(e)) {
                for (var n = this._getMonoCurves(), i = [], r = e.y, s = [], a = 0, o = n.length; o > a; a++) {
                    ...
                    if ((1 === n[a].winding && r >= h[1] && r <= h[7] || r >= h[7] && r <= h[1]) && I.solveCubic(h, 1, r, i, 0, 1) > 0)
                        for (var u = i.length - 1; u >= 0; u--) s.push(I.evaluate(h, i[u], 0).x);
                    if (s.length > 1) break
                }
                e.x = (s[0] + s[1]) / 2
            }
    ...
    var L = e.extend({
            ...
            evaluate: function(t, e) {
                ...
                return I.evaluate(this.curves[n.index], n.value, e)
            },
        ...
        E = e.extend({
            ...
            generateBezier: function(t, e, n, i, r) {
                for (var s = 1e-11, a = this.points[t], o = this.points[e], h = [
                        [0, 0],
                        [0, 0]
        ...
        B = e.extend(new function() {
            function t(t) {
                ...
                if (i) {
                    ...
                    var h = s[t];
                    if (!h) {
                        n || (n = K.getContext(1, 1), n.globalCompositeOperation = "copy"), n.fillStyle = "rgba(0,0,0,0)", n.fillStyle = t, n.fillRect(0, 0, 1, 1);
                ...
                initialize: function l(e) {
                    ...
                    if ("string" === d && e in i && (n = e, e = u[1], Array.isArray(e) ? (s = e, a = u[2]) : (this.__read && (c = 1), u = h.call(u, 1), d = typeof e)), !s) {
                        if (o = "number" === d ? u : "object" === d && null != e.length ? e : null) {
                            ...
                            } else if (e.constructor === D) n = "gradient", o = u;
                        else {
    ...
    var D = e.extend({
        ...
        F = e.extend(new function() {
            ...
            return e.each(n, function(n, a) {
                ...
                s[d] = function(e) {
                    ...
                    var i, r = this._owner,
                        s = r && r._children;
                    if (!s || 0 === s.length || n || r instanceof T) {
                        var i = this._values[a];
                        if (i === t) i = this._defaults[a], i && i.clone && (i = i.clone()), this._values[a] = i;
                        else {
                            var l = o ? B : u ? h : null;
            ...
            _class: "Style",
            initialize: function(t, e, n) {
                this._values = {}, this._owner = e, this._project = e && e._project || n || paper.project, e instanceof N && (this._defaults = this._textDefaults), t && this.set(t)
            },
            set: function(t) {
        ...
        q = new function() {
            ...
            return {
                ...
                isInvisible: function(t) {
                    return q.getSize(t).equals(new c(0, 0))
                },
                isInView: function(t) {
        ...
        V = {
            ...
            getOffset: function(t, e) {
                return V.getPoint(t).subtract(q.getOffset(e || V.getTarget(t)))
            },
            stop: function(t) {
    ...
    V.requestAnimationFrame = new function() {
        ...
        var e, n = q.getPrefixed(window, "requestAnimationFrame"),
            i = !1,
            s = [],
            a = !0;
        return V.add(window, {
    ...
    var Z = e.extend(n, {
            ...
            initialize: function Se(t, e) {
                ...
                var n;
                this._pixelRatio || (this._pixelRatio = window.devicePixelRatio || 1), this._id = e.getAttribute("id"), null == this._id && e.setAttribute("id", this._id = "view-" + Se._id++), V.add(e, this._viewEvents);
                var i = "none";
                if (q.setPrefixed(e.style, {
                    ...
                    var s = q.getOffset(e, !0),
                        a = this;
                    n = q.getViewportBounds(e).getSize().subtract(s), this._windowEvents = {
                        resize: function() {
                            q.isInvisible(e) || (s = q.getOffset(e, !0)), a.setViewSize(q.getViewportBounds(e).getSize().subtract(s))
                        }
                    }, V.add(window, this._windowEvents)
                } else if (n = q.getSize(e), n.isNaN() || n.isZero()) {
                    var o = function(t) {
            ...
            statics: {
                ...
                _id: 0,
                create: function(t, e) {
                    return "string" == typeof e && (e = document.getElementById(e)), new U(t, e)
                }
            }
        }, new function() {
            function t(t) {
        ...
        U = Z.extend({
            ...
            function e(e, n, i, r, s, a) {
                function o(e) {
                    return e.responds(n) && (h || (h = new $(n, i, r, s, a ? r.subtract(a) : null)), e.emit(n, h) && h.isStopped) ? (i.preventDefault(), !0) : t
                }
                for (var h, u = s; u;) {
                    if (o(u)) return !0;
                    u = u.getParent()
        ...
        W = H.extend({
            _class: "KeyEvent",
            initialize: function(t, e, n, i) {
                H.call(this, i), this.type = t ? "keydown" : "keyup", this.key = e, this.character = n
            },
            toString: function() {
        ...
        G = new function() {
            function t(t, n, r, h) {
                var u, l = r ? String.fromCharCode(r) : "",
                    ...
                    p = g && g.tool;
                o[d] = t, c && (u = e.camelize(c)) in s && (s[u] = t), t ? a[n] = r : delete a[n], p && p.responds(f) && (paper = g, p.emit(f, new W(t, d, l, h)), _ && _.update())
            }
            var n, i = {
                    8: "backspace",
                    9: "tab",
        ...
        $ = H.extend({
            _class: "MouseEvent",
            initialize: function(t, e, n, i, r) {
                H.call(this, e), this.type = t, this.point = n, this.target = i, this.delta = r
            },
            toString: function() {
        ...
        J = s.extend({
            ...
            _fireEvent: function(t, e) {
                ...
                return this.responds(t) && this.emit(t, new X(this, t, e))
            },
        ...
        Q = new function() {
            ...
            e.each(y, function(t, e) {
                ...
                x.restore(), w[e] = i
            }), K.release(x), this.process = function(t, e, n, i, r) {
                var p = e.canvas,
                    v = "normal" === t;
        ...
        te = e.each({
            ...
            strokeScaling: ["vector-effect", "lookup", {
                ...
                return !e && (t instanceof A || t instanceof b || t instanceof N)
            }],
    ...
    return new function() {
        ...
        function a(t, e, n, i) {
            ...
            for (var l = 0, c = r.length; c > l; l++) {
                var d, f = r[l];
                1 !== f.nodeType || !(d = P(f, n, !1)) || d instanceof m || u.push(d)
            }
            return a.addChildren(u), s && (a = x(a.reduce(), t, i)), o._currentStyle = h, (s || "defs" === e) && (a.remove(), a = null), a
        }
        ...
        function u(t) {
            ...
            return (e.match(/m/gi) || []).length > 1 || /z\S+/i.test(e) ? new T(n) : new O(n)
        }
        ...
        function l(t, e) {
            ...
            var d, f, _;
            return a ? (d = i(t, "cx", "cy"), f = d.add(n(t, "r"), 0), _ = i(t, "fx", "fy", !0)) : (d = i(t, "x1", "y1"), f = i(t, "x2", "y2")), x(new B(r, d, f, _), t), null
        }
        ...
        function x(n, i, r) {
            var s = {
                node: q.getStyles(i) || {},
                parent: !r && q.getStyles(i.parentNode) || {}
            };
        ...
        function P(t, e, n) {
            ...
            if (n)
                if ("string" != typeof t || /^.*</.test(t)) {
                    ...
                    if (r = document.getElementById(t), !r) return Y.request("get", t, i);
                    t = null
                }
            ...
            if (c.applyMatrix = !1, o = u && u(r, h, e, n) || null, c.applyMatrix = d, o) {
                ...
                var f = e.onImport;
                f && (o = f(r, o, e) || o), e.expandShapes && o instanceof b && (o.remove(), o = o.toPath()), l && (o._data = JSON.parse(l))
            }
            return n && (I = {}), o
        }
        var k = {
        ...
        function a(i, r, a, o) {
            ...
            paper = r;
            var l, c = r.getView(),
                d = /\s+on(?:Key|Mouse)(?:Up|Down|Move|Drag)\b/.test(i) ? new J : null,
                f = d ? d._events : [],
        ...
        function o(t) {
            if (/^text\/(?:x-|)paperscript$/.test(t.type) && "true" !== r.getAttribute(t, "ignore")) {
                ...
                return n.setAttribute(s, o._id), i ? Y.request("get", i, function(t) {
                    a(t, o, i)
        ...
        return h.inject(v), c.inject(v), B.inject(v), "complete" === document.readyState ? setTimeout(u) : V.add(window, {
            load: u
        }), {
            compile: s,
            execute: a,
